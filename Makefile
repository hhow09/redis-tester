...
test_base_with_redis: build
	EXEC_FROM=$(EXEC_FROM) \
	CODECRAFTERS_SUBMISSION_DIR=$(CODECRAFTERS_SUBMISSION_DIR) \
...
test_all_with_redis: 
	...
	make test_repl_with_redis
	make test_rdb_with_redis
	make test_streams_with_redis
	make test_txn_with_redis
